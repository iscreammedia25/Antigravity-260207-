            ...
            const booksData = [
                ...
                { id: 'OG0021', title: 'Milo and the Lost Color', src: './public/Image/Cover/OG0021(Milo and the Lost Color).png', lexile: '320~380', wordCount: 160, category: 'Animals', summary: 'Milo is a dog with a very big imagination. Every time he goes for a walk, he sees a world full of dragons.', keywords: ['dog', 'dream', 'adventure', 'wild'], isBookmarked: true, isUnread: true, videoUrl: './public/Video/Book/Intro/OG0021(Milo and the Lost Color)/OG0021(Milo and the Lost Color)_Intro.mp4' },
            ...
            const MY_LIBRARY_DUMMY_DATA = {
                ...
                favorites: [booksData[6], booksData[7], booksData[8]]
            };
            ...
            const scenesData = [
                ...
                { book_id: "OG0021", scene_no: "SC02", script: "But one morning, he wakes up gray. ?œOh no! Where is my color???Milo says. He looks at his tail. It?™s still gray. He feels sad and shy.", image_url: "./public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC02_I.png", full_audio: "" },
                { book_id: "OG0021", scene_no: "SC03", script: "Milo walks into the forest. He sees a yellow butterfly. ?œCan I borrow your color???he asks.", image_url: "./public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC03_I.png", full_audio: "" },
                { book_id: "OG0021", scene_no: "SC04", script: "The butterfly smiles. ?œMy color is for flying!??Milo smiles back. ?œThen I will keep looking.??He waves goodbye.", image_url: "./public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC04_I.png", full_audio: "" },
                { book_id: "OG0021", scene_no: "SC05", script: "He meets a red flower. ?œCan I have your color???Milo asks. The flower says, ?œMy color helps the bees.??, image_url: "./public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC05_I.png", full_audio: "" },
                { book_id: "OG0021", scene_no: "SC06", script: "Milo is sad. ?œEveryone has their own color.??He sits by a blue pond. A small tear drops into the water.", image_url: "./public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC06_I.png", full_audio: "" },
                ...
                { book_id: "OG0021", scene_no: "SC08", script: "Milo laughs. ?œMaybe my color is inside me!??He takes a deep breath and closes his eyes. His body starts to glow.", image_url: "./public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC08_I.png", full_audio: "" },
                ...
                { book_id: "OG0021", scene_no: "SC10", script: "Milo runs home. He looks in the mirror. ?œI found my color?”me!??he says proudly.", image_url: "./public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC10_I.png", full_audio: "" },
                ...
                { book_id: "OG0050", scene_no: "SC05", script: "Ignoring his friend, Didi grabbed a net and caught a portion of the cloud into a pristine crystal box. ?œGot it!??he shouted triumphantly.", image_url: "./public/Image/Book/OG0050(The Rainbow Cloud in the Box)/OG0050_SC05_I.png", full_audio: "" },
            ...
            const mockScenes = [
                ...
                { id: 'OG0021', scene_no: 'SC02', script: "But one morning, he wakes up gray. ?œOh no! Where is my color???Milo says. He looks at his tail. It?™s still gray. He feels sad and shy.", image_url: './public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC02_I.png', audio_url: '' },
                { id: 'OG0021', scene_no: 'SC03', script: "Milo walks into the forest. He sees a yellow butterfly. ?œCan I borrow your color???he asks.", image_url: './public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC03_I.png', audio_url: '' },
                { id: 'OG0021', scene_no: 'SC04', script: "The butterfly smiles. ?œMy color is for flying!??Milo smiles back. ?œThen I will keep looking.??He waves goodbye.", image_url: './public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC04_I.png', audio_url: '' },
                { id: 'OG0021', scene_no: 'SC05', script: "He meets a red flower. ?œCan I have your color???Milo asks. The flower says, ?œMy color helps the bees.??, image_url: './public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC05_I.png', audio_url: '' },
                { id: 'OG0021', scene_no: 'SC06', script: "Milo is sad. ?œEveryone has their own color.??He sits by a blue pond. A small tear drops into the water.", image_url: './public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC06_I.png', audio_url: '' },
                ...
                { id: 'OG0021', scene_no: 'SC08', script: "Milo laughs. ?œMaybe my color is inside me!??He takes a deep breath and closes his eyes. His body starts to glow.", image_url: './public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC08_I.png', audio_url: '' },
                ...
                { id: 'OG0021', scene_no: 'SC10', script: "Milo runs home. He looks in the mirror. ?œI found my color?”me!??he says proudly.", image_url: './public/Image/Book/OG0021(Milo and the Lost Color)/OG0021_SC10_I.png', audio_url: '' },
                ...
                { id: 'OG0050', scene_no: 'SC05', script: "Ignoring his friend, Didi grabbed a net and caught a portion of the cloud into a pristine crystal box. ?œGot it!??he shouted triumphantly.", image_url: './public/Image/Book/OG0050(The Rainbow Cloud in the Box)/OG0050_SC05_I.png', audio_url: '' },
        ...
        <!-- Unified Media Player Modal (Theater Mode) -->
        <div id="unifiedMediaPlayer"
            class="fixed inset-0 hidden bg-[#030712]/98 flex flex-col items-center justify-center font-fredoka overflow-hidden select-none z-[50000]">
            <!-- Background Blur -->
            <div id="playerBgBlur"
                class="absolute inset-0 z-0 opacity-20 blur-3xl scale-125 transition-all duration-1000"></div>

            <!-- Theater Modal Container -->
            <div id="theaterModal"
                class="relative w-full max-w-5xl lg:max-w-6xl aspect-video bg-black shadow-[0_0_100px_rgba(0,0,0,0.8)] overflow-hidden scale-95 opacity-0 transition-all duration-500 flex flex-col group/player">

                <!-- 1. Top Bar (Title & Tools) -->
                <div
                    class="absolute top-0 left-0 right-0 p-8 flex justify-between items-start z-50 bg-gradient-to-b from-black/80 via-black/40 to-transparent opacity-0 group-hover/player:opacity-100 transition-opacity duration-300">
                    <div class="flex flex-col">
                        <span id="playerMediaTypeLabel"
                            class="text-sky-400 font-black text-xs uppercase tracking-[0.2em] mb-1">Type</span>
                        <h2 id="playerMediaTitle" class="text-white text-3xl font-black font-jua drop-shadow-md">
                            Title</h2>
                    </div>
                    <div class="flex items-center gap-5">
                        <!-- Auto-play Toggle -->
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-md px-5 py-2.5 rounded-2xl border border-white/20 hover:bg-white/20 transition-all cursor-pointer"
                            onclick="togglePlayerAutoPlay()">
                            <span class="text-white/90 font-bold text-sm tracking-tight">Auto-play</span>
                            <div id="playerAutoPlayBtn"
                                class="w-12 h-6 rounded-full relative bg-sky-500 transition-colors">
                                <div id="playerAutoPlayKnob"
                                    class="absolute top-1 w-4 h-4 bg-white rounded-full transition-all left-7">
                                </div>
                            </div>
                        </div>
                        <button onclick="closeUnifiedPlayer()"
                            class="w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center text-white transition-all active:scale-90 border border-white/20 shadow-xl">
                            <i data-lucide="x" class="w-8 h-8"></i>
                        </button>
                    </div>
                </div>

                <!-- 2. Content Area (Video/Audio) -->
                <div class="flex-1 relative flex items-center justify-center overflow-hidden" id="playerMainArea">
                    <!-- Video Element -->
                    <video id="playerVideo" class="w-full h-full object-contain hidden"></video>

                    <!-- Audio UI Elements -->
                    <div id="playerAudioUI"
                        class="w-full h-full hidden flex flex-col items-center justify-center bg-[#0f172a]">
                        <audio id="playerAudio"></audio>
                        <div class="relative z-10">
                            <div
                                class="w-80 h-[460px] bg-white p-5 rounded-[48px] shadow-[0_40px_100px_rgba(0,0,0,0.5)] transform hover:rotate-2 hover:scale-105 transition-all duration-700">
                                <img id="playerAudioThumbnail" src="" class="w-full h-full object-cover rounded-[32px]"
                                    alt="" />
                            </div>
                        </div>
                        <!-- Visualizer -->
                        <div id="playerVisualizer" class="absolute bottom-24 flex items-end gap-1.5 h-12 opacity-50">
                        </div>
                    </div>

                    <!-- Bridge UI Overlay (Full Screen) - Now used only as fallback or legacy -->
                    <div id="playerBridgeUI"
                        class="absolute inset-0 bg-black/80 backdrop-blur-sm z-[60] hidden flex items-center justify-center">
                        <div class="flex flex-col items-center">
                            <div class="relative w-32 h-32 mb-8">
                                <svg class="w-full h-full -rotate-90" viewBox="0 0 128 128">
                                    <circle cx="64" cy="64" r="58" class="stroke-white/10 fill-none" stroke-width="8" />
                                    <circle id="countdownCircle" cx="64" cy="64" r="58" class="stroke-sky-400 fill-none"
                                        stroke-width="8" stroke-dasharray="364.4" stroke-dashoffset="0"
                                        stroke-linecap="round" />
                                </svg>
                                <span id="countdownText"
                                    class="absolute inset-0 flex items-center justify-center text-4xl font-black text-white">3</span>
                            </div>
                            <h3 class="text-2xl font-black text-white drop-shadow-lg">Next episode starting...</h3>
                        </div>
                    </div>

                    <!-- Mini Countdown Badge (Bottom Right) -->
                    <div id="playerMiniCountdown"
                        class="absolute bottom-32 right-8 bg-black/60 backdrop-blur-xl border border-white/20 text-white px-6 py-4 rounded-3xl z-[65] hidden flex items-center gap-4 animate-in fade-in slide-in-from-right-4 duration-300 shadow-2xl">
                        <div class="flex flex-col">
                            <span class="text-[10px] font-black uppercase tracking-widest text-sky-400 opacity-80">Next
                                starts in</span>
                            <span id="miniCountdownText" class="text-3xl font-black leading-none">3</span>
                        </div>
                        <div
                            class="w-10 h-10 border-4 border-white/10 rounded-full flex items-center justify-center relative">
                            <svg class="w-full h-full -rotate-90 scale-110" viewBox="0 0 32 32">
                                <circle id="miniCountdownCircle" cx="16" cy="16" r="14" class="stroke-sky-400 fill-none"
                                    stroke-width="3" stroke-dasharray="88" stroke-dashoffset="0"
                                    stroke-linecap="round" />
                            </svg>
                        </div>
                    </div>
                    ...
                    <!-- End Screen Overlay -->
                    <div id="playerEndScreen"
                        class="absolute inset-0 bg-black/90 backdrop-blur-xl z-[70] hidden flex items-center justify-center">
                        <div id="endScreenContent"
                            class="bg-white rounded-[64px] p-16 max-w-xl w-full mx-6 shadow-2xl flex flex-col items-center text-center scale-95 opacity-0 transition-all duration-500">
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="absolute bottom-0 left-0 right-0 p-8 pt-20 bg-gradient-to-t from-black/90 via-black/60 to-transparent z-50 opacity-0 group-hover/player:opacity-100 transition-opacity duration-300">
                    <!-- Progress Slider -->
                    <div class="relative w-full h-8 flex items-center group/progress cursor-pointer mb-6"
                        id="playerProgressContainer" onclick="handleProgressBarClick(event)">
                        <div class="absolute w-full h-2 bg-white/20 rounded-full overflow-hidden">
                            <div id="playerProgressBar"
                                class="h-full bg-sky-400 rounded-full w-0 shadow-[0_0_10px_rgba(56,189,248,0.5)]">
                            </div>
                        </div>
                        <div id="playerProgressKnob"
                            class="absolute w-5 h-5 bg-white rounded-full shadow-xl scale-0 group-hover/progress:scale-100 transition-transform duration-200 left-0 -ml-2.5">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-8">
                            <div class="flex items-center gap-4">
                                <button onclick="playPrevious()"
                                    class="w-12 h-12 text-white/70 hover:text-white transition-all active:scale-90">
                                    <i data-lucide="skip-back" class="w-8 h-8 fill-current"></i>
                                </button>
                                <button onclick="togglePlayerPlay()"
                                    class="w-16 h-16 bg-white text-[#0f172a] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-90 transition-all">
                                    <i data-lucide="play" id="playerPlayIcon" class="w-9 h-9 fill-current ml-1"></i>
                                </button>
                            ...
                            <div
                                class="text-white font-bold text-sm tracking-widest tabular-nums bg-white/10 px-4 py-2 rounded-xl">
                                <span id="playerCurrentTime">00:00</span>
                                <span class="mx-2 text-white/30">/</span>
                                <span id="playerTotalTime" class="text-white/60">00:00</span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-6">
                            <div
                                class="flex items-center gap-4 bg-white/5 rounded-2xl px-5 py-2.5 hover:bg-white/10 transition-all">
                                <button onclick="togglePlayerMute()"
                                    class="text-white/70 hover:text-white transition-all">
                                    <i data-lucide="volume-2" id="playerVolumeIcon" class="w-6 h-6"></i>
                                </button>
                            </div>
                            <button onclick="togglePlayerFullscreen()"
                                class="w-14 h-14 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center text-white transition-all active:scale-90 border border-white/10">
                                <i data-lucide="maximize" id="playerFullscreenIcon" class="w-7 h-7"></i>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            // (Globals moved to first script tag)

            function openUnifiedPlayer(items, startIndex = 0) {
                if (items) {
                    playerMediaList = items;
                }
                playerCurrentIndex = startIndex;

                const playerOverlay = document.getElementById('unifiedMediaPlayer');
                ...
                // Animation trigger
                setTimeout(() => {
                    theaterModal.classList.remove('scale-95', 'opacity-0');
                    theaterModal.classList.add('scale-100', 'opacity-100');
                }, 50);

                loadPlayerMedia(playerCurrentIndex);
                lucide.createIcons();
            }

            function closeUnifiedPlayer() {
                const theaterModal = document.getElementById('theaterModal');
                theaterModal.classList.add('scale-95', 'opacity-0');
                theaterModal.classList.remove('scale-100', 'opacity-100');
                ...
                setTimeout(() => {
                    ...
                    video.pause();
                    audio.pause();
                    document.getElementById('unifiedMediaPlayer').classList.add('hidden');
                    clearInterval(playerCountdownTimer);
                    clearInterval(playerVisualizerInterval);
                    isMiniCountdownRunning = false;
                    document.getElementById('playerMiniCountdown').classList.add('hidden');
                }, 400);
            }

            function loadPlayerMedia(index) {
                const media = playerMediaList[index];
                if (!media) return;
                ...
                // UI Setup
                document.getElementById('playerMediaTitle').innerText = media.title;
                document.getElementById('playerMediaTypeLabel').innerText = media.type;

                // Premium background: use thumbnail with heavy blur
                const bgBlur = document.getElementById('playerBgBlur');
                bgBlur.style.backgroundImage = `url(${media.thumb})`;
                bgBlur.style.backgroundSize = 'cover';
                bgBlur.style.backgroundPosition = 'center';
                bgBlur.classList.remove('opacity-0');
                bgBlur.classList.add('opacity-40');

                // Reset UI
                video.classList.add('hidden');
                document.getElementById('playerAudioUI').classList.add('hidden');
                document.getElementById('playerBridgeUI').classList.add('hidden');
                document.getElementById('playerEndScreen').classList.add('hidden');

                // Stop current
                video.pause();
                audio.pause();

                const currentMediaEl = (media.type === 'Audio Book') ? audio : video;

                if (media.type === 'Audio Book') {
                    const audioUI = document.getElementById('playerAudioUI');
                    audioUI.classList.remove('hidden');
                    audioUI.classList.add('flex'); // Ensure flex is on
                    document.getElementById('playerAudioThumbnail').src = media.thumb;
                    audio.src = media.src;
                    audio.load();
                ...
                // Events
                currentMediaEl.onended = handleMediaEnd;
                currentMediaEl.onloadedmetadata = () => {
                    document.getElementById('playerTotalTime').innerText = formatTime(currentMediaEl.duration);
                };
                currentMediaEl.ontimeupdate = () => {
                    const prog = (currentMediaEl.currentTime / currentMediaEl.duration) * 100;
                    document.getElementById('playerProgressBar').style.width = `${prog}%`;
                    document.getElementById('playerCurrentTime').innerText = formatTime(currentMediaEl.currentTime);
                    const knob = document.getElementById('playerProgressKnob');
                    if (knob) knob.style.left = `${prog}%`;

                    // Mini Countdown Logic (Video only)
                    if (isPlayerAutoPlay && media.type !== 'Audio Book') {
                        const timeLeft = currentMediaEl.duration - currentMediaEl.currentTime;
                        if (timeLeft <= 3.5 && !isMiniCountdownRunning) {
                            startMiniCountdown();
                        }
                    }
                };
            ...
            function startMiniCountdown() {
                if (isMiniCountdownRunning) return;
                isMiniCountdownRunning = true;

                const mini = document.getElementById('playerMiniCountdown');
                const miniText = document.getElementById('miniCountdownText');
                const miniCircle = document.getElementById('miniCountdownCircle');

                mini.classList.remove('hidden');

                let count = 3;
                miniText.innerText = count;
                miniCircle.style.strokeDashoffset = 0;
                ...
                playerCountdownTimer = setInterval(() => {
                    ...
                    if (count <= 0) {
                        ...
                        miniText.innerText = displayCount;
                        // dasharray is 88
                        miniCircle.style.strokeDashoffset = (88 * (3 - count)) / 3;
                    }
                }, 100);
            }
            ...
            function handleMediaEnd() {
                if (isPlayerAutoPlay) {
                    // Implement looping within the current list
                    playerCurrentIndex++;
                    if (playerCurrentIndex >= playerMediaList.length) {
                        playerCurrentIndex = 0; // Back to start
                    }
                    loadPlayerMedia(playerCurrentIndex);
                } else {
                    showEndScreen();
            ...
            function startBridge() {
                const bridge = document.getElementById('playerBridgeUI');
                ...
                playerCountdownTimer = setInterval(() => {
                    ...
                    if (count <= 0) {
                        ...
                        text.innerText = count;
                        circle.style.strokeDashoffset = (364.4 * (3 - count)) / 3;
                    }
                }, 1000);
            }

            function showEndScreen() {
                const screen = document.getElementById('playerEndScreen');
                const content = document.getElementById('endScreenContent');
                screen.classList.remove('hidden');

                const nextMedia = playerMediaList[playerCurrentIndex + 1];
                ...
                if (nextMedia) {
                    content.innerHTML = `
                    <p class="text-sky-500 font-extrabold text-sm uppercase tracking-widest mb-6">Finished!</p>
                    <div class="relative w-full aspect-video bg-slate-100 rounded-[40px] overflow-hidden mb-8 shadow-2xl group/next cursor-pointer" onclick="playNextDirectly()">
                        <img src="${nextMedia.thumb}" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-black/30 flex items-center justify-center opacity-0 group-hover/next:opacity-100 transition-opacity">
                             <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-2xl">
                                <i data-lucide="play" class="w-10 h-10 text-sky-500 fill-current ml-1"></i>
                             </div>
                        </div>
                    </div>
                    <h3 class="text-3xl font-black text-slate-800 font-jua mb-10">${nextMedia.title}</h3>
                    <div class="flex gap-4 w-full">
                        <button onclick="closeUnifiedPlayer()" class="flex-1 py-6 bg-slate-100 text-slate-500 rounded-[32px] font-black hover:bg-slate-200 transition-all">Close</button>
                        <button onclick="playNextDirectly()" class="flex-[1.5] py-6 bg-sky-500 text-white rounded-[32px] font-black shadow-lg shadow-sky-200 hover:scale-105 active:scale-95 transition-all">Play Next Now</button>
                    </div>
                `;
                } else {
                    content.innerHTML = `
                    <div class="w-24 h-24 bg-sky-100 rounded-full flex items-center justify-center mb-8 mx-auto">
                        <i data-lucide="sparkles" class="w-12 h-12 text-sky-500 fill-current"></i>
                    </div>
                    <h3 class="text-4xl font-black text-slate-800 font-jua mb-4">Excellent Job!</h3>
                    <p class="text-slate-400 font-bold mb-12">You've finished all the media in this series.</p>
                    <button onclick="closeUnifiedPlayer()" class="w-full py-6 bg-sky-500 text-white rounded-[32px] font-black shadow-lg shadow-sky-200 hover:scale-105 active:scale-95 transition-all">Back to Library</button>
                `;
                }
                lucide.createIcons();
            }
            ...
            function playNextDirectly() {
                playerCurrentIndex++;
                if (playerCurrentIndex >= playerMediaList.length) playerCurrentIndex = 0;
                loadPlayerMedia(playerCurrentIndex);
            }
            ...
            function togglePlayerPlay() {
                const media = playerMediaList[playerCurrentIndex].type === 'Audio Book' ? document.getElementById('playerAudio') : document.getElementById('playerVideo');
                if (media.paused) { media.play(); updatePlayIcon(true); }
                else { media.pause(); updatePlayIcon(false); }
            }

            function updatePlayIcon(isPlaying) {
                const icon = document.getElementById('playerPlayIcon');
                if (icon) {
                    icon.parentElement.innerHTML = `<i data-lucide="${isPlaying ? 'pause' : 'play'}" id="playerPlayIcon" class="w-9 h-9 fill-current ${isPlaying ? '' : 'ml-1'}"></i>`;
                    lucide.createIcons();
                }
            }
            ...
            function togglePlayerAutoPlay() {
                isPlayerAutoPlay = !isPlayerAutoPlay;
                const knob = document.getElementById('playerAutoPlayKnob');
                const btn = document.getElementById('playerAutoPlayBtn');
                if (isPlayerAutoPlay) {
                    knob.style.left = '28px';
                    btn.classList.add('bg-sky-500'); btn.classList.remove('bg-slate-600');
                } else {
                    knob.style.left = '4px';
                    btn.classList.remove('bg-sky-500'); btn.classList.add('bg-slate-600');
                }
            }

            function togglePlayerFullscreen() {
                const playerArea = document.getElementById('theaterModal');
            ...
            function startVisualizer() {
                ...
                for (let i = 0; i < 30; i++) {
                    ...
                    bar.className = 'w-1.5 bg-sky-400 rounded-full transition-all duration-200';
                    bar.style.height = '4px';
                    viz.appendChild(bar);
                }
                clearInterval(playerVisualizerInterval);
                playerVisualizerInterval = setInterval(() => {
                    viz.childNodes.forEach(bar => {
            ...
            function startMiniCountdown() {
                const el = document.getElementById('playerMiniCountdown');
                const text = document.getElementById('miniCountdownText');
                if (!el || !text) return;
            ...
            function prepareAndPlayMedia(index, listJson) {
                const items = JSON.parse(decodeURIComponent(listJson));
                openUnifiedPlayer(items, index);
            }
